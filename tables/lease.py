lease_cols = ', '.join(['Id', 'Entrata_Id__c', 'Email__c', 'Start_Date__c', 'End_Date__c', 'Parking_Space__c', 'Lessee_Name__c', 'Monthly_Rate__c', 'Lease_Contract_Owner__c', 'Parking_Space__r.name', 'Lease_Contract_Owner__r.name'])
